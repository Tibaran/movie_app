...
class Tms{
  ...
  static final String _currentDate = formatter.format(now);
  ...
  static String getUrl(String lat, String lng){
    return "${baseUrl}showings?startDate=$_currentDate&lat=$lat&lng=$lng&api_key=$apiKey";
  }
